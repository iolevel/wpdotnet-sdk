...
The solution compiles all of WordPress into a .NET assembly and additionally provides C# wrappers for the utilization of yhe compiled sources. The project consists of several parts:
