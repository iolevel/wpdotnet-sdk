...
> *MyHelloDollyPlugin.msbuildproj:*
```xml
<Project Sdk="PeachPied.WordPress.Build.Plugin/5.8.0-preview9">
...
Note the project file specifies a version after the slash, i.e. `"/5.8.0-preview9"`. This corresponds to the version of *PeachPied.WordPress.** packages which should be identical across all your application.
