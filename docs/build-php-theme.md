...
> *MyWordPressTheme.msbuildproj:*
```xml
<Project Sdk="PeachPied.WordPress.Build.Plugin/1.0.0-beta980">
  <PropertyGroup>
...
Note the project file specifies a version after the slash, i.e. `"/1.0.0-beta980"`. This corresponds to the version of *PeachPied.WordPress.** packages which should be identical across all your application.
