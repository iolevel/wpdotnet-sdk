...
Note the project file specifies a version after the slash, i.e. `"/1.0.0-preview1"`. This corresponds to the version of *PeachPied.WordPress.** packages which should be identical across all your application.
